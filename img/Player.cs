...
public class Player : MonoBehaviour
{
    ...
    Vector3 CheckWallRays(Vector3 pos, float direction)  //di chuyển
    {
    ...
    Vector3 CheckFloorRays(Vector3 pos)  //nhảy
    {
    ...
    Vector3 CheckCeilingRays (Vector3 pos)
    {
        ...
        RaycastHit2D ceilLeft = Physics2D.Raycast(originLeft, Vector2.up, velocity.x * Time.deltaTime, wallMask);
        RaycastHit2D ceilMiddle = Physics2D.Raycast(originMiddle, Vector2.up, velocity.x * Time.deltaTime, wallMask);
        RaycastHit2D ceilRight = Physics2D.Raycast(originRight, Vector2.up, velocity.x * Time.deltaTime, wallMask);
